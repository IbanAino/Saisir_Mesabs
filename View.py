...
class Entry_Table_X_Y(tk.Frame):
    ...
    def reset_Data(self):
        ...
        self.time_3_Var.set('')
        self.time_4_Var.set('')
        self.text_angle_1.config(text = '0')
        self.text_angle_2.config(text = '0')
        self.text_angle_3.config(text = '0')
        self.text_angle_4.config(text = '0')
...
class Entry_Angles_From_Target(tk.Frame):
    def __init__(self):
        ...
        ttk.Label(self, text='V2 sonde en bas', background = 'Light Grey').grid(row = 2, column = 1, sticky = tk.E)
        ttk.Label(self, text='V1 sonde en haut', background = 'Light Grey').grid(row = 1, column = 4, sticky = tk.E)
